export default function GrowthTimeline() {
  ...
  return (
    <div>
      <h2 className="font-light text-lg mb-4 text-gray-600">Growth Timeline</h2>
      <p className="text-sm text-gray-500 mb-2">Current day: 30 | Sown: 01/03/2025</p>
      <ul className="space-y-2 text-sm">
        {stages.map((s, i) => (
          <li key={i} className="border-b pb-2">
            <p className="font-medium text-gray-600">{s.stage}</p>
